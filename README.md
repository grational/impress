...
The current main branch is configured for the Java and Groovy versions in
[lib/build.gradle](lib/build.gradle). A legacy Java 8 / Groovy 3 compatible
branch is documented as `java-8-groovy-3` and released with the project’s
