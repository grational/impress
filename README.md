...
Compatibility releases are organized around Groovy major versions because
Groovy is also a runtime dependency:
...
| `1.1.0-j8g3` | `java-8-groovy-3` | 8+ | 3.x | You are maintaining this Java 8 / Groovy 3 compatibility line. |
